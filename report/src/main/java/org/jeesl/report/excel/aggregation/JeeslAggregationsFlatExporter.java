...
public class JeeslAggregationsFlatExporter
{
    ...
    final static Logger logger = LoggerFactory.getLogger(JeeslAggregationsFlatExporter.class);
	
    public JeeslAggregationsFlatExporter(Info infoSection, Figures firstFigures)
    {
	...
	public void addContent(List<String> parents, Figures figures)
	{
