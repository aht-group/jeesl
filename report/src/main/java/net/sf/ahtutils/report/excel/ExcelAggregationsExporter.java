...
public class ExcelAggregationsExporter
{
    ...
    final static Logger logger = LoggerFactory.getLogger(ExcelAggregationsExporter.class);
	
    public ExcelAggregationsExporter(Info infoSection, Figures firstFigures) throws Exception
    {
