...
public class AbstractDummyFacade implements JeeslFacade
{
	...
	@Override public <T extends EjbWithId, E1 extends Enum<E1>,  E2 extends Enum<E2>, E3 extends Enum<E3>, I extends EjbWithId> T oneForParents(Class<T> cl, E1 p1Name, I p1, E2 p2Name, I p2, E3 p3Name, I p3) throws JeeslNotFoundException {return null;}
	...
	@Override
	public <L extends JeeslLang, D extends JeeslDescription, S extends EjbWithId, G extends JeeslGraphic<GT,GC,GS>, GT extends JeeslGraphicType<L,D,GT,G>, GC extends JeeslGraphicComponent<G,GC,GS>, GS extends JeeslGraphicShape<L,D,GS,G>> S loadGraphic(Class<S> cS, S status) {
		// TODO Auto-generated method stub
		return null;
	}
	...
	@Override
	public <W extends JeeslWithType<T>, T extends JeeslStatus<?, ?, T>> JsonTuples1<T> tpcWithType(Class<W> cWith,
			Class<T> cType) {
		// TODO Auto-generated method stub
		return null;
	}
