					...
					implements JeeslWorkflowRestExportInterface
{
	...
	private final JeeslWorkflowFacade<WP,WS,WST,WSP,WPT,WML,WSN,WT,WTT,AC,WA,AB,AO,MT,MC,SR,AL,WF,WY,WD,USER> fWorkflow;
	...
	private WorkflowRestService(WorkflowFactoryBuilder<L,D,WX,WP,WPD,WS,WST,WSP,WPT,WML,WSN,WT,WTT,AC,WA,AB,AO,MT,MC,SR,RE,RA,AL,WF,WY,WD,FRC,USER> fbWorkflow,
			JeeslWorkflowFacade<WP,WS,WST,WSP,WPT,WML,WSN,WT,WTT,AC,WA,AB,AO,MT,MC,SR,AL,WF,WY,WD,USER> fWorkflow)
	{
