...
public class AbstractJeeslFacadeBean implements JeeslFacade
{
	...
	@Override public <L extends JeeslLang,D extends JeeslDescription, S extends EjbWithId,G extends JeeslGraphic<GT,F,FS>, GT extends JeeslGraphicType<L,D,GT,G>, F extends JeeslGraphicComponent<G,GT,F,FS>, FS extends JeeslGraphicShape<L,D,FS,G>> S loadGraphic(Class<S> cS, S status){return fJeesl.loadGraphic(cS,status);}
