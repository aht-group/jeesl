...
//			else
			...
			else if(e instanceof jakarta.persistence.PersistenceException)
			{
				...
				else
				{
					...
					sb.append("Not handled error:").append(jakarta.persistence.PersistenceException.class.getName());
			...
			{
				logger.error("It's not a "+jakarta.persistence.PersistenceException.class.getName()+" ...");
	...
	{
		ParentPredicate<GP> ppGrandparent = ParentPredicateBuilder.create(gpObject, gpName);
		return this.fForAndOrGrandParents(queryClass,pClass,pName,ParentPredicateBuilder.list(ppGrandparent),ParentPredicateBuilder.empty());
	}
