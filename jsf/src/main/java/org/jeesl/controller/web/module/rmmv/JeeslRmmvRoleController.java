...
public class JeeslRmmvRoleController <L extends JeeslLang, D extends JeeslDescription, LOC extends JeeslLocale<L,D,LOC,?>,
		...
		implements SbSingleBean
{
	...
	final static Logger logger = LoggerFactory.getLogger(JeeslRmmvRoleController.class);
	
	private final JeeslRmmvRoleCallback callback;
	...
	public JeeslRmmvRoleController(final JeeslRmmvRoleCallback callback,
	...
	public void postConstructRole(JeeslRmmvFacade<L,D,R,E,EC,MOD,MC,?,?,?> fRmmv,
