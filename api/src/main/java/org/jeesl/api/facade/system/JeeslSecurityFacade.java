...
//	R load(R role, boolean withUsers);
	...
	List<M> fSecurityMenus(JeeslSecurityQuery<CTX,R> query);
	...
	<S extends JeeslStaff<R,USER,D1,D2>, D1 extends EjbWithId, D2 extends EjbWithId> List<S> fStaff(Class<S> cStaff, JeeslSecurityQuery<CTX,R> query);
