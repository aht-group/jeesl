		...
		implements Serializable
{
	...
	private JeeslCalendarFacade<YEAR,?,?,?,CALENDAR,ZONE,SCOPE,ITEM,IT,USER> fCalendar;
	...
	public void postConstructTimeZone(JeeslCalendarFacade<YEAR,?,?,?,CALENDAR,ZONE,SCOPE,ITEM,IT,USER> fCalendar,
