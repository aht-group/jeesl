								...
								implements JeeslAssetCacheBean<REALM,RREF,COMPANY,SCOPE,ASSET,ASTATUS,ATYPE,VIEW,ETYPE,UP>
{
	...
	public void postConstruct(JeeslAomFacade<L,D,REALM,COMPANY,ASSET,ASTATUS,ATYPE,VIEW,EVENT,ESTATUS,UP> fAsset)
	{
	...
	public void reloadRealm(JeeslAomFacade<L,D,REALM,COMPANY,ASSET,ASTATUS,ATYPE,VIEW,EVENT,ESTATUS,UP> fAsset, REALM realm, RREF rref)
	{
		reloadAssetTypes(fAsset,realm,rref,false);
		reloadCompanies(fAsset,realm,rref);
	}
	
	private void reloadAssetTypes(JeeslAomFacade<L,D,REALM,COMPANY,ASSET,ASTATUS,ATYPE,VIEW,EVENT,ESTATUS,UP> fAsset, REALM realm, RREF rref, boolean force)
	{		
		reloadAssetTypes1(fAsset,realm,rref,force);
		reloadAssetTypes2(fAsset,realm,rref,force);
	}
	
	private void reloadAssetTypes1(JeeslAomFacade<L,D,REALM,COMPANY,ASSET,ASTATUS,ATYPE,VIEW,EVENT,ESTATUS,UP> fAsset, REALM realm, RREF rref, boolean force)
	{		
...
//	}
	...
	private void reloadAssetTypes2(JeeslAomFacade<L,D,REALM,COMPANY,ASSET,ASTATUS,ATYPE,VIEW,EVENT,ESTATUS,UP> fAsset, REALM realm, RREF rref, boolean force)
	{		
...
//	}
	...
	private void reloadCompanies(JeeslAomFacade<L,D,REALM,COMPANY,ASSET,ASTATUS,ATYPE,VIEW,EVENT,ESTATUS,UP> fAsset, REALM realm, RREF rref)
	{
