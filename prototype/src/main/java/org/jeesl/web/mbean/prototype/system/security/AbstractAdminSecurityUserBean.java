		...
		implements Serializable
{
	...
	protected JeeslSecurityFacade<C,R,V,U,A,AT,CTX,M,USER> fUtilsSecurity;
	...
	public void postConstructSecurityUser(JeeslTranslationBean<L,D,LOC> bTranslation, JeeslFacesMessageBean bMessage,
							JeeslUserFacade<USER> fUtilsUser, JeeslSecurityFacade<C,R,V,U,A,AT,CTX,M,USER> fUtilsSecurity)
	{
