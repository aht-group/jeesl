		...
		implements JeeslAppCalendarBean<L,D,CALENDAR,ZONE,CT,ITEM,IT,USER>
{
	...
	private JeeslCalendarFacade<YEAR,?,?,?,CALENDAR,ZONE,CT,ITEM,IT,USER> fCalendar;
	...
	public void postConstructTimeZone(JeeslCalendarFacade<YEAR,?,?,?,CALENDAR,ZONE,CT,ITEM,IT,USER> fCalendar)
	{
