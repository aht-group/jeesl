		...
		implements Serializable
{
	...
	private JeeslSecurityFacade<?,?,V,?,?,?> fSecurity;
	...
	public void postConstructSystemPage(JeeslSecurityFacade<?,?,V,?,?,?> fSecurity, JeeslTranslationBean<L,D,?> bTranslation, JeeslFacesMessageBean bMessage)
	{
