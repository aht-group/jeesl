...
create table IoAttributeItem (id  bigserial not null, code varchar(255), position int4 not null, remark text, tableHeader boolean, visible boolean not null, criteria_id int8, section_id int8, set_id int8, primary key (id));
