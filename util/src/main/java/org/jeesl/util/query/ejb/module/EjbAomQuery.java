...
>
			...
			implements JeeslAomQuery<REALM,ASSET,ATYPE,EVENT,ESTATUS>
{
	...
	public void apply(JeeslAomQuery<REALM,ASSET,ATYPE,EVENT,ESTATUS> other)
	{
	...
	//Fetches
	public <E extends Enum<E>> EjbAomQuery<REALM,ASSET,ATYPE,EVENT,ESTATUS> addRootFetch(E e) {if(rootFetches==null) {rootFetches = new ArrayList<>();} rootFetches.add(e.toString()); return this;}
	...
	@Override public EjbAomQuery<REALM,ASSET,ATYPE,EVENT,ESTATUS> codeList(List<String> list) {if(Objects.isNull(codeList)) {codeList = new ArrayList<>();} codeList.addAll(list); return this;}
	...
	public EjbAomQuery<REALM,ASSET,ATYPE,EVENT,ESTATUS> tenant(TenantIdentifier<REALM> identifier) {this.tenantIdentifier=identifier; return this;}
	
	//LocalDate
	public EjbAomQuery<REALM,ASSET,ATYPE,EVENT,ESTATUS> ld1(LocalDate ld1) {this.localDate1 = ld1; return this;}
	public EjbAomQuery<REALM,ASSET,ATYPE,EVENT,ESTATUS> ld2(LocalDate ld2) {this.localDate2 = ld2; return this;}
	public EjbAomQuery<REALM,ASSET,ATYPE,EVENT,ESTATUS> ld3(LocalDate ld3) {this.ld3 = ld3; return this;}
	
	// AOM
	private List<ASSET> assets; 
	@Override public List<ASSET> getAssets() {return assets;}
	public EjbAomQuery<REALM,ASSET,ATYPE,EVENT,ESTATUS> add(ASSET asset) {if(Objects.isNull(assets)) {assets = new ArrayList<>();} assets.add(asset); return this;}
	public EjbAomQuery<REALM,ASSET,ATYPE,EVENT,ESTATUS> addAssets(List<ASSET> list) {if(Objects.isNull(assets)) {assets = new ArrayList<>();} assets.addAll(list); return this;}
	public EjbAomQuery<REALM,ASSET,ATYPE,EVENT,ESTATUS> addAssets(Collection<ASSET> collection) {if(Objects.isNull(assets)) {assets = new ArrayList<>();} assets.addAll(collection); return this;}
	...
	public EjbAomQuery<REALM,ASSET,ATYPE,EVENT,ESTATUS> addAomEventStatus(Collection<ESTATUS> collection) {if(Objects.isNull(aomEventStatus)) {aomEventStatus = new ArrayList<>();} aomEventStatus.addAll(collection); return this;}
}