...
public class IoReportStyleComparator<L extends JeeslLang,D extends JeeslDescription,
								...
								TLS extends JeeslStatus<L,D,TLS>>
{
    ...
    public Comparator<STYLE> factory(Type type)
    {
        ...
        IoReportStyleComparator<L,D,CATEGORY,REPORT,IMPLEMENTATION,WORKBOOK,SHEET,GROUP,COLUMN,ROW,TEMPLATE,CELL,STYLE,CDT,CW,RT,ENTITY,ATTRIBUTE,TL,TLS> factory = new IoReportStyleComparator<L,D,CATEGORY,REPORT,IMPLEMENTATION,WORKBOOK,SHEET,GROUP,COLUMN,ROW,TEMPLATE,CELL,STYLE,CDT,CW,RT,ENTITY,ATTRIBUTE,TL,TLS>();
        switch (type)
        {
