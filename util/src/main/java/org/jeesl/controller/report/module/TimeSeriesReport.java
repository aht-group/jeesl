...
//implements JeeslReportHeader//,JeeslFlatReport,JeeslXlsReport
{
	...
	public TimeSeriesReport(String localeCode,
			final JeeslIoReportFacade<L,D,CATEGORY,REPORT,IMPLEMENTATION,WORKBOOK,SHEET,GROUP,COLUMN,ROW,TEMPLATE,CELL,STYLE,CDT,CW,RT,ENTITY,ATTRIBUTE,TL,TLS> fReport,
