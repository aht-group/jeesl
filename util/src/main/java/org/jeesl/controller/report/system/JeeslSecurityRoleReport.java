								...
								USER extends JeeslUser<R>>
{
	...
	public JeeslSecurityRoleReport(String localeCode, SecurityFactoryBuilder<L,D,C,R,V,U,A,AT,?,M,?,?,?,?,?,USER> fbSecurity, JeeslSecurityFacade<C,R,V,U,A,CTX,M,USER> fSecurity)
	{
