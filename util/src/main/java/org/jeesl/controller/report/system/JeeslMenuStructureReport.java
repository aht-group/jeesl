								...
								USER extends JeeslUser<R>>
{
	...
	private final JeeslSecurityFacade<C,R,V,U,A,USER> fSecurity;
...
//	private org.jeesl.factory.xml.system.security.XmlViewFactory<L,D,C,R,V,U,A,AT,USER> xfView;
	...
	public JeeslMenuStructureReport(String localeCode, JeeslSecurityFacade<C,R,V,U,A,USER> fSecurity, SecurityFactoryBuilder<L,D,C,R,V,U,A,AT,CTX,M,?,?,?,?,?,USER> fbSecurity)
	{
