...
public class LabelScopeComparator<L extends JeeslLang,D extends JeeslDescription,
...
{
	final static Logger logger = LoggerFactory.getLogger(LabelScopeComparator.class);

    public enum Type {position};

    public LabelScopeComparator()
    {
    ...
    public Comparator<RS> factory(Type type)
    {
        ...
        LabelScopeComparator<L,D,RC,RV,RVM,RS,RST,RE,REM,RA,RER,RAT> factory = new LabelScopeComparator<L,D,RC,RV,RVM,RS,RST,RE,REM,RA,RER,RAT>();
        switch (type)
        {
