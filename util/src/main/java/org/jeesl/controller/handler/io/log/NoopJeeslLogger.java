...
public class NoopJeeslLogger implements JeeslLogger
{
	private static final long serialVersionUID = 1L;
	final static Logger logger = LoggerFactory.getLogger(NoopJeeslLogger.class);
	

	public static JeeslLogger instance(Class<?> c) {return new NoopJeeslLogger(c);}
	private NoopJeeslLogger(Class<?> c)
	{
...
//	@Override public void milestone(Logger logger, Class<?> c, String message, Integer elements) {}
