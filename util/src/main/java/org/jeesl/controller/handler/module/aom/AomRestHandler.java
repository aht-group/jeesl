					...
					implements JeeslAomRestInterface
{
	...
	protected final JeeslAomFacade<L,D,REALM,COMPANY,ASSET,ASTATUS,ATYPE,ALEVEL,EVENT,ESTATUS,UP> fAsset;
...
//	}
	...
	public AomRestHandler(AomFactoryBuilder<L,D,REALM,COMPANY,SCOPE,ASSET,ASTATUS,ATYPE,ALEVEL,EVENT,ETYPE,ESTATUS,M,MT,USER,FRC,UP> fbAsset,
							JeeslAomFacade<L,D,REALM,COMPANY,ASSET,ASTATUS,ATYPE,ALEVEL,EVENT,ESTATUS,UP> fAsset)
	{
	...
	public JsonSsiUpdate fixMarkup()
	{
		...
		MT markupType = fAsset.fByEnum(fbAsset.getClassMarkupType(), JeeslIoMarkupType.Code.xhtml);
