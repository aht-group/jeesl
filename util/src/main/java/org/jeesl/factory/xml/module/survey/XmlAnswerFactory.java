								...
								CORRELATION extends JeeslSurveyCorrelation<DATA>>
{
	...
	public XmlAnswerFactory(String localeCode, Answer q)
	{
		...
		if(Objects.nonNull(q.getQuestion())) {xfQuestion = new XmlQuestionFactory<>(localeCode,q.getQuestion());}
		if(Objects.nonNull(q.getData())) {xfData = new XmlDataFactory<>(localeCode,q.getData());}
