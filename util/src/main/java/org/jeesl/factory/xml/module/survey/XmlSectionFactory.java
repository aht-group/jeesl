								...
								OPTION extends JeeslSurveyOption<L,D>>
{
	...
	private JeeslSurveyCoreFacade<L,D,?,?,?,SCHEME,?,?,?,SECTION,QUESTION,SCORE,?,?,?,OPTIONS,OPTION,?> fSurvey;
	...
	public void lazyLoad(JeeslSurveyCoreFacade<L,D,?,?,?,SCHEME,?,?,?,SECTION,QUESTION,SCORE,?,?,?,OPTIONS,OPTION,?> fSurvey)
	{
