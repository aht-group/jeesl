				...
				OPTION extends JeeslSurveyOption<L,D>>
{
	...
	private JeeslSurveyCoreFacade<L,D,?,?,?,?,?,?,?,?,SECTION,QUESTION,QE,?,?,?,?,OPTIONS,OPTION,?> fSurvey;
	
	public EjbSurveyQuestionFactory(final Class<QUESTION> cQuestion){this(null,cQuestion);}
	
	public EjbSurveyQuestionFactory(JeeslSurveyCoreFacade<L,D,?,?,?,?,?,?,?,?,SECTION,QUESTION,QE,?,?,?,?,OPTIONS,OPTION,?> fSurvey, final Class<QUESTION> cQuestion)
	{
	...
	public Map<SECTION,List<QUESTION>> loadMap(JeeslSurveyCoreFacade<L,D,?,?,?,?,?,?,?,?,SECTION,QUESTION,QE,?,?,?,?,OPTIONS,OPTION,?> fSurvey)
	{
