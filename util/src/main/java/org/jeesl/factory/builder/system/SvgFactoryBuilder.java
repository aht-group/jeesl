	...
	extends AbstractFactoryBuilder<L,D>
{
	...
	public SvgFactoryBuilder(final Class<L> cL, final Class<D> cD, final Class<G> cG, final Class<GT> cType, final Class<F> cF, final Class<FS> cFs)
	{       
		super(cL,cD);
		this.cG = cG;
		this.cType = cType;
    ...
    public EjbGraphicFactory<L,D,G,GT,F,FS> efGraphic() {return new EjbGraphicFactory<L,D,G,GT,F,FS>(cG,cType,cFs);}
    public EjbGraphicFigureFactory<L,D,G,GT,F,FS> efFigure() {return new EjbGraphicFigureFactory<L,D,G,GT,F,FS>(cF);}
	public EjbStatusFactory<FS,L,D> style() {return EjbStatusFactory.createFactory(cFs,cL,cD);}
	
	public SvgSymbolFactory<L,D,G,GT,F,FS> symbol() {return SvgSymbolFactory.factory();}
	public SvgFigureFactory<L,D,G,GT,F,FS> figure() {return SvgFigureFactory.factory();}
}