										...
										OPTION extends JeeslSurveyOption<L,D>>
{
	...
	private JeeslSurveyCoreFacade<L,D,?,?,?,?,?,?,?,?,SECTION,QUESTION,QE,SCORE,ANSWER,MATRIX,DATA,OPTIONS,OPTION,?> fSurvey;
	...
	public JsonSurveyQuestionFactory(String localeCode, Question q,
			...
			JeeslSurveyCoreFacade<L,D,?,?,?,?,?,?,?,?,SECTION,QUESTION,QE,SCORE,ANSWER,MATRIX,DATA,OPTIONS,OPTION,?> fSurvey)
	{
