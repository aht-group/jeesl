										...
										OPTION extends JeeslSurveyOption<L,D>>
{
	...
	private JeeslSurveyCoreFacade<L,D,?,?,?,?,?,?,SECTION,QUESTION,SCORE,ANSWER,MATRIX,DATA,?> fSurvey;
	...
	public JsonSurveyQuestionFactory(String localeCode, Question q,
			...
			JeeslSurveyCoreFacade<L,D,?,?,?,?,?,?,SECTION,QUESTION,SCORE,ANSWER,MATRIX,DATA,?> fSurvey)
	{
