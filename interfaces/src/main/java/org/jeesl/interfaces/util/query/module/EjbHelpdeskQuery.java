			...
			extends AbstractEjbQuery
{
	...
	@Override public <T extends EjbWithId> EjbHelpdeskQuery<L,D,R,RREF,CAT,TICKET,STATUS,EVENT,TYPE,LEVEL,PRIORITY,USER> ids(List<T> ids) {logger.error("NYI"); return this;}
