...
public class JeeslClChecklistWc <RREF extends EjbWithId>
					extends JeeslClChecklistGwc<IoLang,IoDescription,IoLocale,TenantRealm,RREF,ClChecklist,ClTopic>
{
	private static final long serialVersionUID = 1L;
	
	public JeeslClChecklistWc(ChecklistFactoryBuilder<IoLang,IoDescription,TenantRealm,ClChecklist,ClTopic> fbCl)
	{
		super(fbCl);	
	}
}