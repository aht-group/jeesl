...
@Entity
public class ClTrackList2 implements JeeslClTracklist<IoLang,TenantRealm,ClCheckList2>
{
	...
	@JoinTable(name="ClTracklistJtChecklist",joinColumns={@JoinColumn(name="tracklist_id")},inverseJoinColumns={@JoinColumn(name="checklist_id")},uniqueConstraints=@UniqueConstraint(columnNames={"tracklist_id","checklist_id"}))
	private List<ClCheckList2> checklists;
	@Override public List<ClCheckList2> getChecklists() {if(Objects.isNull(checklists)) {checklists = new ArrayList<>();} return checklists;}
	@Override public void setChecklists(List<ClCheckList2> checklists) {this.checklists = checklists;}

	
	@Override public boolean equals(Object object) {return (object instanceof ClTrackList2) ? id == ((ClTrackList2) object).getId() : (object == this);}
