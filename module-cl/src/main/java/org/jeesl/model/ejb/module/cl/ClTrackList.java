...
@Entity
public class ClTrackList implements JeeslClTracklist<IoLang,TenantRealm,ClCheckList>
{
	...
	private List<ClCheckList> checklists;
	@Override public List<ClCheckList> getChecklists() {if(Objects.isNull(checklists)) {checklists = new ArrayList<>();} return checklists;}
	@Override public void setChecklists(List<ClCheckList> checklists) {this.checklists = checklists;}
