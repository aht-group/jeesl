...
@Entity
public class ClCheckList2 implements JeeslClChecklist<IoLang,TenantRealm,ClTopic>
{
	...
	@Override public boolean equals(Object object) {return (object instanceof ClCheckList2) ? id == ((ClCheckList2) object).getId() : (object == this);}
