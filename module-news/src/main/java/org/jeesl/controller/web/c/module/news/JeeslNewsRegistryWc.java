...
public class JeeslNewsRegistryWc <RREF extends EjbWithId,
									...
									ITEM extends JeeslNewsItem<IoLang,NewsFeed,NewsCategory,USER,M,IoFileContainer>,
									USER extends JeeslSimpleUser,
									M extends JeeslMarkup<MT>,
									MT extends JeeslIoCmsMarkupType<IoLang,IoDescription,MT,?>
>
					extends JeeslNewsRegistryGwc<IoLang,IoDescription,IoLocale,TenantRealm,RREF,NewsFeed,NewsCategory,ITEM,USER,M,MT,IoFileContainer>
{
	private static final long serialVersionUID = 1L;

	public JeeslNewsRegistryWc(NewsFactoryBuilder<IoLang,IoDescription,IoLocale,TenantRealm,NewsFeed,NewsCategory,ITEM,USER,M,MT> fbNews)
	{
		super(fbNews);
	}
}