...
public class RevisionScopeType extends IoStatus implements JeeslRevisionScopeType<IoLang,IoDescription,RevisionScopeType,IoGraphic>
{
	...
	@Override public boolean equals(Object object) {return (object instanceof RevisionScopeType) ? id == ((RevisionScopeType) object).getId() : (object == this);}
