...
public class LabelAttributeType extends IoStatus implements JeeslRevisionAttributeType<IoLang,IoDescription,LabelAttributeType,IoGraphic>
{
	...
	@Override public boolean equals(Object object) {return (object instanceof LabelAttributeType) ? id == ((LabelAttributeType) object).getId() : (object == this);}
