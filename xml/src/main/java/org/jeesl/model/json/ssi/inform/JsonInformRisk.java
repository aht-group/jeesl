...
public class JsonInformRisk implements Serializable
{
	...
	private List<JsonInformRating> ratings;
	public List<JsonInformRating> getRatings() {return ratings;}
	public void setRatings(List<JsonInformRating> ratings) {this.ratings = ratings;}
