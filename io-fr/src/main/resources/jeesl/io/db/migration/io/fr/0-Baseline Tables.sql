...
create table IoFileStorage (id  bigserial not null, code varchar(255), fileSizeLimit int8, json text, keepRemoved boolean, position int4 not null, engine_id int8, type_id int8, primary key (id));
