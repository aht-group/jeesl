...
public class IoDbPgConnectionColumn extends IoStatus implements JeeslDbConnectionColumn<IoLang,IoDescription,IoDbPgConnectionColumn,IoGraphic>
{
	...
	@Override public boolean equals(Object object) {return (object instanceof IoDbPgConnectionColumn) ? id == ((IoDbPgConnectionColumn) object).getId() : (object == this);}
