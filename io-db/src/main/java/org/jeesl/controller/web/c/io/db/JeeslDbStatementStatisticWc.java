...
public class JeeslDbStatementStatisticWc extends JeeslDbStatementStatisticGwc<IoLang,IoDescription,IoLocale,IoSsiSystem,IoSsiHost,IoDbStatement,IoDbStatementGroup,IoDbStatementColumn>
{
	private static final long serialVersionUID = 1L;
	
	public JeeslDbStatementStatisticWc(String dbName)
	{
		super(dbName,
