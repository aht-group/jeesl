...
public class JeeslDbMetaWc extends JeeslDbMetaGwc<IoLang,IoDescription,IoLocale,IoSsiSystem,IoDbMetaSnapshot,IoDbMetaTable,IoDbMetaColumn,IoDbMetaColumnType,IoDbMetaConstraint,IoDbMetaConstraintType,IoDbMetaDifference>
{
	private static final long serialVersionUID = 1L;
	
	public JeeslDbMetaWc(JeeslIoDbMetaCallback callback, IoDbMetaFactoryBuilder<IoLang,IoDescription,IoSsiSystem,IoDbMetaSnapshot,IoDbMetaTable,IoDbMetaColumn,IoDbMetaColumnType,IoDbMetaConstraint,IoDbMetaConstraintType,IoDbMetaDifference> fbDb)
	{
		super(callback,fbDb);	
	}
}