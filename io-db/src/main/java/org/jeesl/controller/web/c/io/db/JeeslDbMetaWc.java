...
public class JeeslDbMetaWc extends JeeslDbMetaGwc<IoLang,IoDescription,IoLocale,IoSsiSystem,IoDbMetaSnapshot,IoDbMetaTable,IoDbMetaConstraint>
{
	private static final long serialVersionUID = 1L;
	
	public JeeslDbMetaWc(IoDbMetaFactoryBuilder<IoLang,IoDescription,IoSsiSystem,IoDbMetaSnapshot,IoDbMetaTable,IoDbMetaConstraint> fbDb)
	{
		super(fbDb);	
	}
}