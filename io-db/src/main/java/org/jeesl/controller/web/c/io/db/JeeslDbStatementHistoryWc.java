...
public class JeeslDbStatementHistoryWc extends JeeslDbStatementHistoryGwc<IoLang,IoDescription,IoLocale,IoSsiSystem,IoSsiHost,IoDbStatement,IoDbStatementGroup,IoDbStatementColumn>
{
	...
	public JeeslDbStatementHistoryWc(String dbName)
	{
		super(new IoDbPgFactoryBuilder<>(IoLang.class,IoDescription.class,IoDbConnectionColumn.class,IoDbStatement.class,IoDbStatementGroup.class,IoDbStatementColumn.class,IoDbReplicationColumn.class,IoDbReplicationState.class,IoDbReplicationSync.class),
