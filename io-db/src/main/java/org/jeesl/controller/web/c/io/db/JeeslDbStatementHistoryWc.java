...
public class JeeslDbStatementHistoryWc extends JeeslDbStatementStatisticGwc<IoLang,IoDescription,IoLocale,IoSsiSystem,IoDbStatementColumn>
{
	private static final long serialVersionUID = 1L;
	
	public JeeslDbStatementHistoryWc(String dbName, IoDbPgFactoryBuilder<IoLang,IoDescription,IoDbConnectionColumn,IoDbStatementColumn,IoDbReplicationColumn,IoDbReplicationState,IoDbReplicationSync> fbDb)
	{
		super(dbName,fbDb);	
	}
}