create table IoDbStatement (id  bigserial not null, average float8 not null, calls int4 not null, code varchar(255), record timestamp, refId int8 not null, remark text, rows int4 not null, sql text, total float8 not null, group_id int8, host_id int8, primary key (id));
...
alter table IoDbStatement add constraint UK6dbq2166aemeihvp97wnv51jb unique (host_id, record, refId);
