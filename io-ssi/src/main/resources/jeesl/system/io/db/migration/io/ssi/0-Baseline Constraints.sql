alter table IoSsiCredential add constraint uk_IoSsiCredential_system_code unique (system_id, code);
...
alter table IoSsiCredential add constraint fk_IoSsiCredential_system foreign key (system_id) references IoSsiSystem;
