...
create table IoMavenEeReferral (id  bigserial not null, position int4 not null, recommendation boolean, remark text, artifact_id int8, bom_id int8, edition_id int8, standard_id int8, primary key (id));create table IoMavenGroup (id  bigserial not null, code varchar(255), primary key (id));
