...
create table IoMavenVersion (id  bigserial not null, code varchar(255), label varchar(255), position int4 not null, artifact_id int8, maintainer_id int8, outdate_id int8, primary key (id));