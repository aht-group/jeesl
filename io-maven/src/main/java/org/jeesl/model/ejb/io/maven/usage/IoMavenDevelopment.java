...
public class IoMavenDevelopment implements JeeslIoMavenDevelopment
{
	...
	@Override public boolean equals(Object object){return (object instanceof IoMavenDevelopment) ? id == ((IoMavenDevelopment) object).getId() : (object == this);}
